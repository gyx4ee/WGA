...
Версия `0.2.54` поправя portable съхранението на продуктови ключове, нормализирането и активацията за Windows 10/11 и инсталирането на Adobe Reader чрез WinGet.
