...
Версия `0.2.48` показва постоянно бутоните за прилагане на XP оптимизацията и връщане на настройките в Windows 10 менюто и добавя директен BAT launcher за тест.
