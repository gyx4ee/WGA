...
Версия `0.2.49` възстановява автоматичното обновяване в новия Suite launcher: при налична версия вече има бутон за инсталиране, потвърждение, прогрес, безопасна подмяна на файловете и рестартиране.
