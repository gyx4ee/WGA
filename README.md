...
Версия `0.2.45` добавя нов borderless стартов екран WinSys Guardian Suite преди съществуващия WGA loader. Екранът предоставя отделни входове за WGA, Оптимизация и Network Monitoring, като WGA стартира текущото приложение, а останалите модули са подготвени за самостоятелно развитие.
