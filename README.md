...
Версия `0.2.43` добавя пълно обновяване на локалните икони, видимо Language меню в навигацията и dashboard quick actions, по-компактна странична навигация и по-чисти Language/Nexus Admin карти.
