...
Версия `0.2.50` поправя скритите бутони в Optimization модула и добавя подробен progress прозорец, както и безопасни профили с архив и възстановяване за Windows 10 и Windows 11.
